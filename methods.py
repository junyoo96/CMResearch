...
#             print("what",domains,domains.size(0))
#             print("aa",bs)
            #selected : [2,0,1]
...
#             print("gg",indeces.long())
    ...
    def fit(self, data):
        ...
        for i, (inputs, _, domains, labels) in enumerate(dataloader):
            ...
            #AGG에서 labels는 one-hot vector가 아닌 그냥 index
...
#             print("mix_indeces",mix_indeces)
#             print("mix_ratios",mix_ratios)
            mix_ratios = mix_ratios.to(inputs.device)
            #??? one hot labels가 실제로는 오메가 function을 안거치나?
